...
#define STOP_TDC_Pin GPIO_PIN_13
#define STOP_TDC_GPIO_Port GPIOC
...
#define GPIO_EXTI0_Pin GPIO_PIN_9
#define GPIO_EXTI0_GPIO_Port GPIOF
#define CSn_spi_Pin GPIO_PIN_4
